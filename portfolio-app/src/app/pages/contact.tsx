...
const Contact = (props: Props) => {
  ...
  const handleSubmit = (e: any) => {
    ...
    emailjs
      ...
      .catch((error) => {
        //   toast.error("Meddelande Misslyckades.")
    ...
    <section className="pt-10 pb-10" id="contact">
      ...
      >
              ...
              <p className="text-neutral-500 max-w-lg mx-auto my-2 font-mono text-sm text-center relative z-10 pt-6">
                Your message is important to me. Use this form to
                reach out about anything such as job offers, projects, ideas, or
                just to say hi. Can't wait to hear from you!
              </p>
              </motion.div>
              <motion.div variants={fadeIn("up", "spring", 0.8, 1)}>
              <p className="text-muted text-purple-400 max-w-lg mx-auto my-2 font-mono text-sm text-center relative z-10 py-6">You can write the message in either Swedish or English.</p>
              </motion.div>
