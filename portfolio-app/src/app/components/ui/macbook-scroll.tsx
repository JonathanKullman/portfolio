...
export const MacbookScroll = ({
  ...
  return (
    ...
    <div
      ref={ref}
      className="min-h-[130vh] py-20 flex flex-col items-center font-mono mt-30 justify-start flex-shrink-0 [perspective:200px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
